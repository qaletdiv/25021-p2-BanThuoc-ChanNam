      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="flex items-center gap-4">
            <Link
              href="/"
              className={`text-gray-700 hover:text-blue-800 ${pathname === '/' ? 'font-medium text-blue-800' : ''}`}
            >
              Trang chủ
            </Link>
            <Link
              href="/products"
              className={`text-gray-700 hover:text-blue-800 ${pathname === '/products' ? 'font-medium text-blue-800' : ''}`}
            >
              Sản phẩm
            </Link>
